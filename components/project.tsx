...
export default function Project({
  ...
  return (
    ...
    >
      <section className="bg-gray-200 max-w-[24rem] sm:max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative h-[auto] sm:h-[20rem] hover:bg-gray-200 transition">
